...
const saveLocalStorage = arrayCarrito => {
  localStorage.setItem('items', JSON.stringify(arrayCarrito ))
}
...
//logica del boton "añadir al carrito"

// const botonesAñadir = document.querySelectorAll('.botonAñadir');
// botonesAñadir.forEach(botonAñadir=>{
//   botonAñadir.addEventListener('click', botonAñadirClickeado);
// });

// const divCarro = document.querySelectorAll('.container3');


// function botonAñadirClickeado(event){
//   const boton = event.target;
//   const card = boton.closest('.card');

//   const nombreProducto = card.querySelector('.nombre__producto').textContent;
//   const precioProducto = card.querySelector('.card__title').textContent;
//   const imgProducto = card.querySelector('.card__img').src;

//   agregarAlCarrito (nombreProducto,precioProducto,imgProducto);

// }

// function agregarAlCarrito(nombreProducto, precioProducto, imgProducto){
//   const carroShop = document.createElement('div');
//   const itemCarro = `
//   <div class="card2">
//   <img src="https://images.unsplash.com/photo-1531608139434-1912ae0713cd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE5fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500&q=60" alt="" class="card__img2">  
//   <p name="news" class="bici_desc2">Mountain bike Venzo Loki Evo R29 </p>
//   <div class="card__info2">
//     <div class="card__user2">
//       <label for="disponibles">Cantidad:</label>    
//           <input type="number" id="tentacles" name="tentacles" value="1" min="1" max="100">
//       </div>
//       <div class="bici__text2"> 
//           <h3 class="card__title2">$259.999</h3>
//           <i class="fa-solid fa-cart-shopping"></i>
//       </div> 
//   </div>
//   </div>
//   `;
//   carroShop.innerHTML = itemCarro;
//   divCarro.append(carroShop);
// }
